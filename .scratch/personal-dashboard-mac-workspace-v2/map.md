...
- [02 — 建立 list-first This Week 与 temporary sheet](issues/02-list-first-this-week-temporary-sheet.md) — ready-for-agent

## Blocked tickets

- [03 — 完成 selected scheduled 与 unscheduled workout recording](issues/03-record-selected-and-unscheduled-workouts.md) — blocked by 02
- [04 — 完成 change-time 与 skip 例外流程](issues/04-change-time-and-skip-exceptions.md) — blocked by 02
