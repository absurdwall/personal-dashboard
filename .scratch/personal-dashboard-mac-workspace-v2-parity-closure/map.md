...
| [03 — Integrated responsive and accessibility parity](issues/03-integrated-responsive-and-accessibility-parity.md) | Prove the complete interaction surface across sizes and input modes | resolved | 01, 02 |
| [04 — Final packaged v2 parity gate](issues/04-final-packaged-v2-parity-gate.md) | Close the round only with direct packaged-app evidence | resolved | 01, 02, 03 |
