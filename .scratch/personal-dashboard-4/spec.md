...
Stage: 用户已确认需求、原型方向及测试边界；正式规格已发布，下一阶段为 to-tickets
Date: 2026-09-17
...
User-confirmed testing boundary for 4.0 (2026-09-17):
...
Implementation tickets should deliver complete usable slices, each with its own persistence and behavior checks; final packaged acceptance integrates those slices rather than deferring all verification to the end. This is the published specification for ticket decomposition; publication does not start product implementation.


## Design Sources

- [Confirmed design discussion](design-discussion.md)
- [Accepted prototype and fixed capture](prototype-review.md)
- [Original scope and checklist reconciliation](scope-draft.md)
