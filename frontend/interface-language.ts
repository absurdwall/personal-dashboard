...
const interfaceCopies = {
  ...
  "today.timelineIntro": { zh: "有时刻的任务、日记安排和已确认事实共用一条全天时间轴，并标明各自来源；时间经过不会自动变成事实。没有明确时刻的日记内容留在未定位区，记录原文和修订仍可展开查看。", en: "Timed tasks, Diary arrangements, and confirmed facts share one full-day timeline with their sources labeled. Time passing never becomes fact automatically. Diary content without a precise time stays in the unlocated section, and source records and revisions remain available below." },
  ...
  "today.sourceTask": { zh: "任务", en: "Task" },
  "today.sourceArrangement": { zh: "日记安排", en: "Diary arrangement" },
  "today.sourceConfirmedFact": { zh: "日记事实", en: "Diary fact" },
  ...
  "tasks.timePassed": { zh: "已过设定时间", en: "Scheduled time has passed" },
  ...
  "today.tasksReady": { zh: "已读取所选日期及过往日期的待处理任务。", en: "Loaded tasks for the selected date and pending work from earlier dates." },
