...
const interfaceCopies = {
  ...
  "today.timelineIntro": { zh: "当前安排与明确已确认事实并排使用同一全天时间尺；没有明确时刻的内容保留在未定位区。时间经过不会自动变成事实，记录原文和修订仍可展开阅读。", en: "Current arrangements and explicitly confirmed facts share one full-day time scale. Items without a precise time stay in separate lists. Time passing never becomes fact automatically; source records and revisions remain available below." },
